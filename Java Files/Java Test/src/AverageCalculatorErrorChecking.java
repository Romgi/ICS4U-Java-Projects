...
public class AverageCalculatorErrorChecking {
    public static void main(String[] args){
        ...
        while(!isError){
            ...
            System.out.println("Enter grade 2: "); double grade2 = sc.nextDouble(); if(grade2 < 0 || grade1 > 100){isError = true; break;}
            System.out.println("Enter grade 3: "); double grade3 = sc.nextDouble(); if(grade3 < 0 || grade1 > 100){isError = true; break;}
            System.out.println("Enter grade 4: "); double grade4 = sc.nextDouble(); if(grade4 < 0 || grade1 > 100){isError = true; break;}
